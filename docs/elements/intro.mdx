...
| ---                               | ---       | ---           | ---           | ---           |
| [simpleElementExample](simpleElementExample/intro)    | 3   | Active        | 14.1          | Examples for building, running, parameterizing, etc. simulations and elements | 
| [simpleExternalElement](simpleExternalElement/intro)  | 3   | Active        | 14.1          | Example of an element library external to the sst-elements repository |
...
| Element Name                      | Maturity  | Dev Path      | Last Release  | Description   |
| ---                               | ---       | ---           | ---           | ---           |
| [ember](ember/intro)              | 3 	      | Active        | 14.1          | Communication motifs for network simulations |
| [firefly](firefly/intro)          | 3 	      | Active        | 14.1          | Low-level communication protocol for use with system network simulations |
| [hermes](hermes/intro)            | 3 	      | Active        | 14.1          | Interface to message passing functions for system network simulations |
| [iris](iris/intro)                | 1 	      | Active        | 14.1          | Communication middleware targeting the Mercury simulation environment |
| [macro](macro/intro)              | 3         | Maintenance   | 14.1          | Simulation of coarse-grain distributed memory applications |
| [mask-mpi](maskmpi/intro)         | 3 	      | Active        | 14.1          | An MPI implementation which targets the SUMI (see Iris) interface |
| [mercury](mercury/intro)          |	1 	      | Active        | 14.1          | Support for workload/application models |
| [thornhill](thornhill/intro)      |	1 	      | Maintenance   | 14.1          | Support library for detailed endpoint models in Ember | 
| [zodiac](zodiac/intro) 	          |	1 	      | Maintenance   | 14.1          | Trace-based endpoints for network simulation |

### Networks
| Element Name                      | Maturity  | Dev Path      | Last Release  | Description   |
| ---                               | ---       | ---           | ---           | ---           |
| [kingsley](kingsley/intro)        |	2 	      | Active        | 14.1          | Simulates a mesh network-on-chip |
| [merlin](merlin/intro)            |	3 	      | Active        | 14.1          | Router model with flexible topology modules to simulate networks. |
| [shogun](shogun/intro)            | 2 	      | Active        | 14.1          | Provides a simple crossbar model | 

### Processors
| Element Name                      | Maturity  | Dev Path      | Last Release  | Description   |
| ---                               | ---       | ---           | ---           | ---           |
| [ariel](ariel/intro) 	            | 3 	      | Active        | 14.1          | Dynamic trace-based model leveraging PIN to execute x86 binaries |
| [balar](balar/intro) 	            | 2 	      | Active        | 14.1          | GPU component based on GPGPU-Sim |
| [gensa](gensa/intro)              | 1         | Active        | 14.1         | Neuromorphic processor |
| [juno](juno/intro)                | 2         | Maintenance   | 14.1          | Example pipeline processor model with a custom ISA |
| [llyr](llyr/intro)                | 1         | Active        | Never         | A spatial compute accelerator model |
| [miranda](miranda/intro)          |	3 	      | Active        | 14.1          | Processor driven by a state machine to generate memory instructions |
| [prospero](prospero/intro)        | 2 	      | Active        | 14.1          | Processor that reads a trace from file |
| [serrano](serrano/intro)          | 1         | Experimental  | Never         | Coarse-grain reconfigurable processor model |
| [vanadis](vanadis/intro)          |	2 	      | Active        | 14.1          | Core pipeline model supporting RISC-V and MIPS |

### Cache and Memory System
| Element Name                      | Maturity  | Dev Path      | Last Release  | Description   |
| ---                               | ---       | ---           | ---           | ---           |
| [cacheTracer](cacheTracer/intro)  | 1 	      | Maintenance   | 14.1          | Intercepts cache accesses for observation |
| [cassini](cassini/intro)          | 2 	      | Active        | 14.1          | Prefetchers and other memory system plug-in modules |
| [cramSim](cramsim/intro)          | 2 	      | Maintenance   | 14.1          | Memory model from IBM - DDR, HBM |
| [memHierarchy](memHierarchy/intro)|	3 	      | Active        | 14.1          | Memory system components including caches, directories, and memory controllers and models |
| [messier](messier/intro)          |	2 	      | Active        | 14.1          | Provides a detailed model for NVM-based DIMMs with high-end internal controller |
| [mmu](mmu/intro)                  |	1 	      | Active        | 14.1          | A basic TLB/MMU implementation that works with Vanadis |
| [opal](opal/intro)                | 1         | Active        | Never         | Memory allocation support for multi-node simulations using Ariel |
| [rdmaNic](rdmaNic/intro)          | 1 	      | Active        | 14.1          | Facilitates RDMA in conjunction with Vanadis | 
| [samba](samba/intro)              | 2         | Maintenance   | 14.1          | A detailed memory management unit (MMU) model |
| [vaultsim](vaultsim/intro)        |	3 	      | Maintenance   | 14.1          | Models a vaulted memory architecture | 
