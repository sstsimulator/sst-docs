...
## [SST Community Libraries](http://sst-simulator.org/SSTPages/SSTMainCommunity/)
The pages in this area describe the libraries available from the SST project. Many other libraries are available, check out the [community page](http://sst-simulator.org/SSTPages/SSTMainCommunity/).
...
| ---                               | ---       | ---           | ---           | ---           |
| [simpleElementExample](simpleElementExample/intro)    | 3   | Active        | 13.0          | Examples for building, running, parameterizing, etc. simulations and elements | 
| [simpleExternalElement](simpleExternalElement/intro)  | 3   | Active        | 13.0          | Example of an element library external to the sst-elements repository |
...
| Element Name                      | Maturity  | Dev Path      | Last Release  | Description   |
| ---                               | ---       | ---           | ---           | ---           |
| [ember](ember/intro)              | 3 	      | Active        | 13.0          | Communication motifs for network simulations |
| [firefly](firefly/intro)          | 3 	      | Active        | 13.0          | Low-level communication protocol for use with system network simulations |
| [hermes](hermes/intro)            | 3 	      | Active        | 13.0          | Interface to message passing functions for system network simulations |
| [macro](macro/intro)              | 3         | Maintenance   | 13.0          | Simulation of coarse-grain distributed memory applications |
| [mercury](mercury/intro)          |	1 	      | Active        | 13.0          | Support for workload/application models |
| [thornhill](thornhill/intro)      |	1 	      | Maintenance   | 13.0          | Support library for detailed endpoint models in Ember | 
| [zodiac](zodiac/intro) 	          |	1 	      | Maintenance   | 13.0          | Trace-based endpoints for network simulation |

### Networks
| Element Name                      | Maturity  | Dev Path      | Last Release  | Description   |
| ---                               | ---       | ---           | ---           | ---           |
| [kingsley](kingsley/intro)        |	2 	      | Active        | 13.0          | Simulates a mesh network-on-chip |
| [merlin](merlin/intro)            |	3 	      | Active        | 13.0          | Router model with flexible topology modules to simulate networks. |
| [shogun](shogun/intro)            | 2 	      | Active        | 13.0          | Provides a simple crossbar model | 

### Processors
| Element Name                      | Maturity  | Dev Path      | Last Release  | Description   |
| ---                               | ---       | ---           | ---           | ---           |
| [ariel](ariel/intro) 	            | 3 	      | Active        | 13.0          | Dynamic trace-based model leveraging PIN to execute x86 binaries |
| [balar](balar/intro) 	            | 2 	      | Active        | 13.0          | GPU component based on GPGPU-Sim |
| [gensa](gensa/intro)              | 1         | Experimental  | Never         | Neuromorphic processor |
| [juno](juno/intro)                | 2         | Maintenance   | 13.0          | Example pipeline processor model with a custom ISA |
| [llyr](llyr/intro)                | 1         | Active        | Never         | A spatial compute accelerator model |
| [miranda](miranda/intro)          |	3 	      | Active        | 13.0          | Processor driven by a state machine to generate memory instructions |
| [prospero](prospero/intro)        | 2 	      | Active        | 13.0          | Processor that reads a trace from file |
| [serrano](serrano/intro)          | 1         | Experimental  | Never         | Coarse-grain reconfigurable processor model |
| [vanadis](vanadis/intro)          |	2 	      | Active        | 13.0          | Core pipeline model supporting RISC-V and MIPS |

### Cache and Memory System
| Element Name                      | Maturity  | Dev Path      | Last Release  | Description   |
| ---                               | ---       | ---           | ---           | ---           |
| [cacheTracer](cacheTracer/intro)  | 1 	      | Maintenance   | 13.0          | Intercepts cache accesses for observation |
| [cassini](cassini/intro)          | 2 	      | Active        | 13.0          | Prefetchers and other memory system plug-in modules |
| [Cramsim](cramsim/intro)          | 2 	      | Maintenance   | 13.0          | Memory model from IBM - DDR, HBM |
| [memHierarchy](memHierarchy/intro)|	3 	      | Active        | 13.0          | Memory system components including caches, directories, and memory controllers and models |
| [messier](messier/intro)          |	2 	      | Active        | 13.0          | Provides a detailed model for NVM-based DIMMs with high-end internal controller |
| [mmu](mmu/intro)                  |	1 	      | Active        | 13.0          | A basic TLB/MMU implementation that works with Vanadis |
| [opal](opal/intro)                | 1         | Active        | Never         | Memory allocation support for multi-node simulations using Ariel |
| [rdmaNic](rdmaNic/intro)          | 1 	      | Active        | 13.0          | Facilitates RDMA in conjunction with Vanadis | 
| [samba](samba/intro)              | 2         | Maintenance   | 13.0          | A detailed memory management unit (MMU) model |
| [VaultSimC](vaultsimc/intro)      |	3 	      | Maintenance   | 13.0          | Models a vaulted memory architecture | 

### Other/Miscellaneous
| Element Name                      | Maturity  | Dev Path      | Last Release  | Description   |
| ---                               | ---       | ---           | ---           | ---           |
| [osseous](osseous/intro)          | 1 	      | Active        | Never         | Supports generation of SST components from RTL via [Essent](https://github.com/ucsc-vama/essent) |